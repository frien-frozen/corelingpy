...
export type Theme = {
  ...
  // Coreling brand accent (green). Values MUST be rgb() strings in
...
const lightTheme: Theme = {
  ...
  claude: 'rgb(40,140,80)', // Brand orange darkened for contrast on white
  claudeShimmer: 'rgb(80,250,123)', // Full brand orange as the shimmer highlight
  brand: 'rgb(40,140,80)', // Brand orange darkened for contrast on white
  brandShimmer: 'rgb(80,250,123)', // Full brand orange as the shimmer highlight
  ...
  // TUI V2 colors
  clawd_body: 'rgb(40,140,80)', // Brand orange (light variant)
  ...
  briefLabelClaude: 'rgb(40,140,80)', // Brand orange (light variant, matches claude)
...
const lightDaltonizedTheme: Theme = {
  ...
  claude: 'rgb(50,130,70)', // Brand orange darkened for white bg, luminance-separated from warning
  claudeShimmer: 'rgb(100,220,150)', // Lighter brand orange for shimmer effect
  brand: 'rgb(50,130,70)', // Brand orange darkened for white bg, luminance-separated from warning
  brandShimmer: 'rgb(100,220,150)', // Lighter brand orange for shimmer effect
  ...
  chromeYellow: 'rgb(251,188,4)', // Chrome yellow
  // TUI V2 colors
  clawd_body: 'rgb(50,130,70)', // Brand orange (light daltonized variant)
  clawd_background: 'rgb(0,0,0)',
  ...
  fastModeShimmer: 'rgb(255,150,50)', // Lighter orange for shimmer
  briefLabelYou: 'rgb(37,99,235)', // Blue
  briefLabelClaude: 'rgb(50,130,70)', // Brand orange adjusted for deuteranopia (matches claude)
  rainbow_red: 'rgb(235,95,87)',
  rainbow_orange: 'rgb(245,139,87)',
  rainbow_yellow: 'rgb(250,195,95)',
  rainbow_green: 'rgb(145,200,130)',
...
const darkTheme: Theme = {
  ...
  claude: 'rgb(80,250,123)', // Coreling brand green
  claudeShimmer: 'rgb(255,177,95)', // Lighter brand orange for shimmer effect
  brand: 'rgb(80,250,123)', // Coreling brand green
  ...
  chromeYellow: 'rgb(251,188,4)', // Chrome yellow
  // TUI V2 colors
  clawd_body: 'rgb(80,250,123)', // Brand orange
  clawd_background: 'rgb(0,0,0)',
  ...
  briefLabelClaude: 'rgb(80,250,123)', // Brand orange (matches claude)
  rainbow_red: 'rgb(235,95,87)',
  rainbow_orange: 'rgb(245,139,87)',
  rainbow_yellow: 'rgb(250,195,95)',
  rainbow_green: 'rgb(145,200,130)',
...
const darkDaltonizedTheme: Theme = {
  ...
  claude: 'rgb(100,220,150)', // Brand orange adjusted for deuteranopia (luminance-separated from error/warning)
  claudeShimmer: 'rgb(255,195,115)', // Lighter brand orange for shimmer effect
  brand: 'rgb(100,220,150)', // Brand orange adjusted for deuteranopia (luminance-separated from error/warning)
  ...
  chromeYellow: 'rgb(251,188,4)', // Chrome yellow
  // TUI V2 colors
  clawd_body: 'rgb(100,220,150)', // Brand orange (dark daltonized variant)
  clawd_background: 'rgb(0,0,0)',
  userMessageBackground: 'rgb(55, 55, 55)', // Lighter grey for better visual contrast
  userMessageBackgroundHover: 'rgb(70, 70, 70)',
  messageActionsBackground: 'rgb(44, 50, 62)', // cool gray, slight blue
  ...
  fastModeShimmer: 'rgb(255,165,70)', // Lighter orange for shimmer
  briefLabelYou: 'rgb(122,180,232)', // Light blue
  briefLabelClaude: 'rgb(100,220,150)', // Brand orange adjusted for deuteranopia (matches claude)
  rainbow_red: 'rgb(235,95,87)',
  rainbow_orange: 'rgb(245,139,87)',
  rainbow_yellow: 'rgb(250,195,95)',
  rainbow_green: 'rgb(145,200,130)',
