export const uz = {
  ...
  'commands.theme.description': 'Mavzuni o\'zgartirish',
  'commands.vim.description': 'Vim va oddiy tahrir rejimini almashtirish',
  'commands.doctor.description':
    'Coreling o\'rnatishini va sozlamalarini tekshirish',
  'commands.provider.description': 'API provayder profillarini boshqash',
  'commands.permissions.description':
    'Ruxsat qoidalari (allow / deny)',
  'commands.rewind.description':
    'Kod va/yoki suhbatni oldingi holatga qaytarish',
  'commands.rename.description': 'Joriy suhbatni qayta nomlash',
} as const
