...
import gatewayLlamaCpp from '../gateways/llama-cpp.js'
...
export const GATEWAY_DESCRIPTORS = [gatewayAtomicChat, gatewayAzureOpenai, gatewayBedrock, gatewayCustom, gatewayDashscopeCn, gatewayDashscopeIntl, gatewayGithubEnterprise, gatewayGithub, gatewayGitlawbOpengateway, gatewayGroq, gatewayHicap, gatewayKimiCode, gatewayLlamaCpp, gatewayLmstudio, gatewayMistral, gatewayNvidiaNim, gatewayOllama, gatewayOpencodeGo, gatewayOpencode, gatewayOpenrouter, gatewayTogether, gatewayVertex] as const satisfies readonly GatewayDescriptor[]
...
export const PROVIDER_PRESET_MANIFEST = [
  ...
  },
  {
    ...
    "description": "Free cloud models included with Coreling v2 — no API key needed (prompts leave your machine).",
  ...
  },
  {
    ...
    "vendorId": "openai",
    "gatewayId": "llama-cpp",
    "description": "Spark · Chat · Pro — 100% local & private (Qwen 2.5 via llama.cpp).",
